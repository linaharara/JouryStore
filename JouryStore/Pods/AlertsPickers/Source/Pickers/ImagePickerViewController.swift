...
extension UIAlertController {
    ...
    public func addImagePicker(flow: UICollectionView.ScrollDirection, paging: Bool, height: CGFloat? = nil, images: [UIImage], selection: ImagePickerViewController.SelectionType? = nil) {
...
final public class ImagePickerViewController: UIViewController {
    ...
    required public init(flow: UICollectionView.ScrollDirection, paging: Bool, data: [UIImage], selection: SelectionType?) {
        self.data = data
