...
extension UIAlertController {
    ...
    public func addDatePicker(mode: UIDatePicker.Mode, date: Date?, minimumDate: Date? = nil, maximumDate: Date? = nil,local:NSLocale? = nil,calender:NSCalendar? = nil, action: DatePickerViewController.Action?) {
...
final public class DatePickerViewController: UIViewController {
    ...
    required public init(mode: UIDatePicker.Mode, date: Date? = nil, minimumDate: Date? = nil, maximumDate: Date? = nil, action: Action?,local:NSLocale?,calender:NSCalendar?) {
